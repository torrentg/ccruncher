...
\paragraph{Ejemplo.} La matriz de correlaci\'on sectorial no tiene que 
ser necesariamente definida positiva. Supongamos que tenemos dos sectores, 
entonces la siguiente matriz sectorial es v\'alida y no es definida positiva:
\begin{displaymath}
\Gamma=\left(
\begin{array}{cc}
 0  &  0.1 \cr
0.1 & -0.2
\end{array}
\right) \Longrightarrow det(\Gamma)=-0.01 < 0 \Longrightarrow \Gamma \textrm{ not definite positive}
\end{displaymath}
Supongamos que el sector 1 tiene 3 clientes y el sector 2 tiene 2 clientes. La
...
\begin{array}{ccccc}
 ...
 0.1 & 0.1 &  0  & -0.2 &  1   
\end{array}
\right) \Longrightarrow det(\Theta)=0.912 \textrm{ and definite positive}
\end{displaymath}

\subsection{Propiedades} 

\paragraph{Propiedad 1.} Si la matriz de correlaci\'on sectorial tiene 
todos los elementos comprendidos entre -1 y 1, entonces la matriz de correlaci\'on 
