...
#include <iostream>
#include <cmath>
#include "math/TMFCopulaTest.hpp"
...
//===========================================================================
void ccruncher_test::TMFCopulaTest::test1()
{
  ...
  TMFCopula copula = TMFCopula(correls, vector<unsigned int>(n, n+3), ndf);

  // testing copula
  testCopula(copula, correls, n);

  // checks copula clone method (I)
  TMFCopula *clonedCopula1 = (TMFCopula*) copula.clone(false);
  testCopula(*clonedCopula1, correls, n);
  delete clonedCopula1;

  // checks copula clone method (II)
  TMFCopula *clonedCopula2 = (TMFCopula*) copula.clone(true);
...
//===========================================================================
void ccruncher_test::TMFCopulaTest::test2()
{
  int n[3] = {1, 1, 1};
  vector<vector<double> > correls(3, vector<double>(3));
  ...
  ASSERT_THROW(TMFCopula(correls, vector<unsigned int>(n, n+3), ndf));
...
//===========================================================================
void ccruncher_test::TMFCopulaTest::test3()
{
...
//===========================================================================
void ccruncher_test::TMFCopulaTest::test4()
{
  // valid correlation matrix
  double sigmas[] = {
    +0.2, +0.4, +0.3,
  ...
  vector<vector<double> > correls(3, vector<double>(3));
  for(int i=0; i<3; i++) for(int j=0; j<3; j++) correls[i][j] = sigmas[3*i+j];
  TMFCopula orig = TMFCopula(correls, vector<unsigned int>(n, n+3), ndf);
  TMFCopula copula = TMFCopula(orig);
...
// correlations are true
//===========================================================================
void ccruncher_test::TMFCopulaTest::test5()
{
  // valid correlation matrix
  double sigmas[] = {
    +0.4 , +0.6,
  ...
  TMFCopula copula = TMFCopula(correls, vector<unsigned int>(n, n+2), ndf);
...
// correlations are true
//===========================================================================
void ccruncher_test::TMFCopulaTest::test6()
{
  // valid correlation matrix
  double sigmas[] = {
    +0.4
  ...
  TMFCopula copula = TMFCopula(correls, vector<unsigned int>(n, n+1), ndf);
...
//===========================================================================
void ccruncher_test::TMFCopulaTest::computeDensity(Copula &copula)
{
  double x, y;
  int a, b;
...
//===========================================================================
double ccruncher_test::TMFCopulaTest::pearsn(const vector<double> &x, const vector<double> &y)
{
...
// m: number of sectors
//===========================================================================
int ccruncher_test::TMFCopulaTest::getSector(int x, int *n, int m)
{
  int acum = 0;
  for(int i=0; i<m; i++) {
    acum += n[i];
...
// m: number of sectors
//===========================================================================
void ccruncher_test::TMFCopulaTest::testCopula(Copula &copula, const vector<vector<double> > &correls, int *n)
{
  // number of sectors
  int m = correls.size();
...
//===========================================================================
vector<vector<double> > ccruncher_test::TMFCopulaTest::spearman(const vector<vector<double> > &M)
{
