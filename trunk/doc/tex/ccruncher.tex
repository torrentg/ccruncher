...
rating agency reports us the following PD over time for this
obligor and rating:
\begin{figure}[h]
\centering\includegraphics[width=7cm]{bond_pd}
\end{figure}
\end{example}
...
% {
  ...
  % T[i,] = B[,8]
% }
% pdf(file="bond_pd.pdf")
% plot(0:150, T[1:151,5], type='l', xlab="Time in years", 
