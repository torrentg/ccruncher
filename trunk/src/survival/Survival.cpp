...
//===========================================================================
ccruncher::Survival::Survival(const Ratings &ratings_, int numrows, int *imonths, double **values,
...
//===========================================================================
int ccruncher::Survival::inverse1(const int irating, double val) const
{
  assert(irating < nratings);
  assert(irating >= 0);
...
//===========================================================================
int ccruncher::Survival::inverse(const int irating, double val) const
{
