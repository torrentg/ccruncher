...
// asignation operator
//===========================================================================
Date& ccruncher::Date::operator=( const Date& Orig )
{
    lJulianDay = Orig.lJulianDay;
    return *this;
}
...
//===========================================================================
Date ccruncher::operator+( const Date& Left, const long Right )
{
    Date Temp = Left;
    Temp.lJulianDay += Right;
    return Temp;
}
Date ccruncher::operator+( const long Left, const Date& Right )
{
    Date Temp = Right;
    Temp.lJulianDay += Left;
    return Temp;
}
Date& ccruncher::Date::operator+=( const long Right )
{
    lJulianDay += Right;
    return *this;
}
...
long ccruncher::Date::operator-( const Date& Right )
{
...
//===========================================================================
int ccruncher::Date::operator==( const Date& Right ) const
{
    return lJulianDay == Right.lJulianDay;
}
int ccruncher::Date::operator!=( const Date& Right ) const
