...
elementos usados para la resoluci\'on y se describe el algoritmo de resoluci\'on.
...
\section{M\'etodo de resoluci\'on}

\subsection{Notaci\'on}

\subsection{Reparto del tiempo}

\subsection{Simulaci\'on del rating}
c\'opula -> asignaci\'on -> matriz transici\'on
