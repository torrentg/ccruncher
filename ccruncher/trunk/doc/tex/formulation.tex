...
\subsection{Ejemplo} Matriz de transici\'on anual ($T=1$ a\~no). 
...
\subsection{Tasa de morosidad anticipada acumulada}
...
\paragraph{Ejemplo.} El las figuras \ref{tmaa} se puede observar las Tasas
de Morosidad Anticipada Acumulada de la matriz de transici\'on usada en 
este documento.
