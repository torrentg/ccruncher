...
\paragraph{Netting.} \index{Netting} Importe correspondiente a la liquidaci\'on de
...
\index{Tasa de Morosidad Anticipada} o \emph{Forward Default Rate}
\index{Forward Default Rate} (FDR) del rating $r_i$ en el a\~no $k$ es
...
\index{Tasa de Morosidad Anticipada Acumulada} o \emph{Cumulated Forward Default
Rate}\index{Cumulated Forward Default Rate} (CFDR) del rating $r_i$ en el
...
\paragraph{Ejemplo.} En las figuras \ref{cfdr}, \ref{fdr} y \ref{survival}
