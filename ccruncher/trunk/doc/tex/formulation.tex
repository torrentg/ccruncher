...
deudas mutuas en caso de fallido por el saldo neto de las mismas. Incluye la posible
recuperaci\'on, pago de obligaciones contraidas (pe. en el caso de avales, etc.).
