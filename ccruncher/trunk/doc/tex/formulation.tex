...
tiempo, $\Delta t = t_k-t_0$, la funci\'on de transporte proporciona el factor 
que debe aplicarse a un importe en $t_0$ para obtener el importe equivalente en
$t_k$.
\newline
\newline
...
\paragraph{Ejemplo.} Proporcionada la curva spot, $S$, transportemos el importe 
$C$ que se encuentra en $t=3$ a $t=5$. La curva spot nos proporciona los tipos 
de inter\'es a aplicar desde $t=0$.
\begin{displaymath}
\Upsilon(t_3,t_5, r) = 
\Upsilon(t_3,t_0, S(3)) \cdot \Upsilon(t_0,t_5, S(5)) =
\frac{\Upsilon(t_0,t_5, S(5))}{\Upsilon(t_0,t_3, S(3))}
\end{displaymath}
