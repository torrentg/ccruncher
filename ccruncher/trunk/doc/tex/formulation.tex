...
sencilla, de la que se conoce la distribuci\'on en forma expl\'icita. Sea una
cartera de $1$ solo sector con $100$ clientes, cada uno de ellos con un activo 
que consiste en devolver $1$\$ al cabo de $T$ tiempo. Supongamos que el sistema 
de ratings solamente contempla $2$ categor\'ias crediticias, no-Default y 
Default. La probabilidad de hacer fallido al cabo de $T$ tiempo $0.1$.
