...
We compute the recovery at time nodes as a linear interpolation using defined
asset recoveries just below and over. If don't exist previous recovery we 
considerer a value of $0$. If don't exist subsequent recovery we considerer a 
value of $0$. Figure \ref{recoverymapping} shows recovery displayed in figure 
\ref{recovery} mapped to biannual time nodes.
