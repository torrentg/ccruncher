...
\begin{displaymath}
E(X) \approx \widehat{X} = \frac{1}{n} \sum_{i=1}^{n} x_i
\end{displaymath}
...
usando el siguiente estimador no sesgado:
\begin{displaymath}
...
\section{Error est\'andar de un quantil}

A continuaci\'on se describe el m\'etodo de Maritz-Jarrett basado en el
estad\'istico de orden. Sea $N$ el taman\~o muestral y $x$ la probabilidad
del quantil.
